...
# If there is no /home/simon/SVN/pocketsphinx-0.8/../sphinxbase-0.8 and friends use pkg-config
if '/home/simon/SVN/pocketsphinx-0.8/../sphinxbase-0.8' == '' or '/home/simon/SVN/pocketsphinx-0.8/../sphinxbase-0.8' == '':
    sbconf = pkgconfig('sphinxbase')
    sb_libdirs = sbconf.get('library_dirs', [])
    sb_includes = sbconf.get('include_dirs', [])
else:
    sb_includes = ['/home/simon/SVN/pocketsphinx-0.8/../sphinxbase-0.8/include',
                   '/home/simon/SVN/pocketsphinx-0.8/../sphinxbase-0.8/include']
    sb_libdirs = ['/home/simon/SVN/pocketsphinx-0.8/../sphinxbase-0.8/src/libsphinxbase/.libs']
